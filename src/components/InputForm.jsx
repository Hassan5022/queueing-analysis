...
function InputForm({ setResult }) {
	...
	function calculateOutput(
		...
		console.log(
			`Average Number of Customers when it's not Empty: ${Ls.toFixed(2)}`
		);
	...
	return (
		<Form className="input-form" onSubmit={handleSubmit}>
			<Form.Group className="input-group" controlId="formLambda">
			...
			<Form.Group className="input-group" controlId="formMean">
			...
			<Form.Group className="input-group" controlId="formDistribution">
			...
			{distribution === "uniform" || distribution === "gamma" ? (
				<div>
					<Form.Group className="input-group" controlId="formMinValue">
					...
					<Form.Group className="input-group" controlId="formMaxValue">
			...
			<Form.Group className="input-group" controlId="formServer">
			...
			<Button className="calculate" variant="primary" type="submit">
				Calculate
			</Button>
		</Form>
	);
